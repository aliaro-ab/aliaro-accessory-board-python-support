...
@pytest.fixture
def i2c_driver_board_controller(mock_i2c_driver, board_config: board_config) -> I2CDriverBoardController:
...
def test_read_currents_from_device(i2c_driver_board_controller, mock_i2c_driver, board_config: board_config) -> None:
